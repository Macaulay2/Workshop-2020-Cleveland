...
document {
	...
	"This function is provided by the package ", TO Invariants, ". The hope is that this function will used to compute actual generating invariants, but the crucial step is still missing (the Reynolds operator). For now, it outputs the ideal generated by the invariants in the polynomial ring, as the following example illustrates.",
