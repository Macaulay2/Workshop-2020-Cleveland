...
document {
	Key => {(equivariantHilbertSeries, TorusAction)},
	Headline => "The equivariant Hilbert series for a diagonal torus action",
	Usage => "equivariantHilbertSeries T",
	Inputs => {
	    	"T" => TorusAction => {"a diagonal torus action"},
		},
	Outputs => {
