...
-*doc ///
    ...
    Inputs
        I: Ideal
            in a polynomial ring over ZZ/p for p prime
    Outputs
        : Sequence
            The function outputs (d,e) where 
            
            1. d = dimension of the ideal $I$

            2. e = degree of the saturation of $(I+L)$ with respect to the last coordinate of the polynomial ring where $L$ is a homogeneous
            ideal generated by random $d-1$ forms.
    Description
        Text
    ...
    Example
        ...
        S=kk[y_0..y_14];
        I=minors(2,random(S^3,S^{5:-1}));
        (d,deg)=dimDegViaBezout(I)

        Text
            This speeds up computations  often as we avoid the computation via the GB altogether.
    Example
