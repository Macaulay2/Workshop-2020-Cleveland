...
randomPointViaLinearIntersection = method(Options => {Strategy=>null, Homogeneous => true, Codimension => null, ProjectionAttempts => 20, IntersectionAttempts => 20});
randomPointViaLinearIntersection := opts -> (n1, I1) -> (
    c1 := opts.Codimension;
