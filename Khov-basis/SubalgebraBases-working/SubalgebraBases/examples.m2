...
needs "sagbi.m2"
n=1 -- n=1,2 terminate w/ finite SAGBI bases for the given monomial order
R=QQ[t_1,t_2,t_3,w_(0,1)..w_(n-1,3),v_(0,1)..v_(n-1,3)]
...
elapsedTime wvtSag = basis subalgebraBasis algT;
wvtSag
