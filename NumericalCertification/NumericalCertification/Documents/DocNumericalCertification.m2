...
doc ///
	...
	Description
		...
		The output is a sequence of 3 values, TT{(B,n,r)}. B is a boolean value determining whether certification was successful, n is a lower bound on the number of roots (counting multiplicity) in the cluster, and r is the radius of the ball around TT{p} containing the cluster.
	    Example
	    	R = CC[x,y];
		F = polySystem {x+y^2,y+x^2};
		p = point {{1e-5,-1e-6}};
