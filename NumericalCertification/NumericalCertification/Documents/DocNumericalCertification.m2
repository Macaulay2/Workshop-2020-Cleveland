...
doc ///
	...
	Description
	    Text
	    	This function constructs the operator @TT "A"@ from @HREF("https://arxiv.org/abs/1904.07937","\"On isolation of singular zeros of multivariate analytic systems\" (2020)")@.
...
doc ///
    	Key 
	    certifyCluster
	    (certifyCluster, PolySystem, Point)
	    "(certifyCluster, PolySystem, Point)"
	Headline
